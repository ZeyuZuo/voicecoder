...
- [x] Step 24：补充单元测试：Agent 事件归一化、DemoSession reducer、preview URL 状态、dev server URL 解析。
- [x] Step 25：补充 Rust 测试：JSON-RPC message parser、Codex event parser、provider diagnostics、dev server parser。
