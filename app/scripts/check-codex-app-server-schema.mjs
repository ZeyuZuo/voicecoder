...
const schemaRequirements = [
  ...
  ["v2/ItemGuardianApprovalReviewStartedNotification.json", ["threadId", "turnId", "reviewId", "targetItemId", "startedAtMs", "review", "action"]],
  ["v2/ItemGuardianApprovalReviewCompletedNotification.json", ["threadId", "turnId", "reviewId", "targetItemId", "startedAtMs", "completedAtMs", "decisionSource", "review", "action"]],
...
const fixtureSchemas = [
  ...
  ["file-change-started-notification.json", "v2/ItemStartedNotification.json"],
  ["auto-approval-started-notification.json", "v2/ItemGuardianApprovalReviewStartedNotification.json"],
  ["auto-approval-completed-notification.json", "v2/ItemGuardianApprovalReviewCompletedNotification.json"],
  ["server-request-resolved-notification.json", "v2/ServerRequestResolvedNotification.json"],
